...
@section('styles')
    ...
    <style>
        /* Modern DataTable Styles for tradingPair */
        ...
        #tradingPair thead th:first-child {
            border-top-left-radius: 16px;
        }

        #tradingPair thead th:last-child {
            border-top-right-radius: 16px;
        }

        #tradingPair thead th:hover {
            background: linear-gradient(135deg, #5a6fd8 0%, #6a4190 100%);
            transform: translateY(-1px);
        }

        #tradingPair tbody tr {
            transition: all 0.3s ease;
            border-bottom: 1px solid #f1f5f9;
        }

        #tradingPair tbody tr:hover {
        ...
        #tradingPair tbody tr:last-child {
            border-bottom: none;
        }

        #tradingPair tbody td {
            padding: 16px;
            font-size: 14px;
            color: #374151;
            border: none;
        ...
        #tradingPair tbody tr:nth-child(1) { animation-delay: 0.1s; }
        #tradingPair tbody tr:nth-child(2) { animation-delay: 0.2s; }
        #tradingPair tbody tr:nth-child(3) { animation-delay: 0.3s; }
        #tradingPair tbody tr:nth-child(4) { animation-delay: 0.4s; }
        #tradingPair tbody tr:nth-child(5) { animation-delay: 0.5s; }
