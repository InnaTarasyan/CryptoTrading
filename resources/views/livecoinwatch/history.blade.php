        ...
        <div class="m-portlet" >
            <div class="m-portlet__body mt-5">
                ...
                <div id="datatableFullscreenContainer" class="table-responsive">
                    <div id="datatableLoading" style="display:none; text-align:center; margin:2em;">
                    ...
                    <table id="livecoin_history" class="table table-hover table-condensed table-striped" style="width:100%; padding-top:1%">
                        <thead>
                        <tr>
                           <th title="The cryptocurrency name"><span class="datatable-header-icon">  
                              <!-- Coin SVG -->
                           ...
                           <th title="Coin logo"><span class="datatable-header-icon">
                              <!-- Logo SVG -->
                           ...
                           <th title="Current price in USD"><span class="datatable-header-icon">
                              <!-- Dollar SVG -->
                           ...
                           <th title="How old the coin is"><span class="datatable-header-icon">
                              <!-- Hourglass SVG -->
                           ...
                           <th title="Number of trading pairs"><span class="datatable-header-icon">
                              <!-- Pairs SVG -->
                           ...
                           <th title="24h trading volume"><span class="datatable-header-icon">
                              <!-- Exchange SVG -->
                           ...
                           <th title="Market capitalization"><span class="datatable-header-icon">
                              <!-- Pie Chart SVG -->
                           ...
                           <th title="Rank among all coins"><span class="datatable-header-icon">
                              <!-- Trophy SVG -->
                           ...
                           <th title="Number of markets"><span class="datatable-header-icon">
                              <!-- List SVG -->
                           ...
                           <th title="Total supply of the coin"><span class="datatable-header-icon">
                              <!-- Database SVG -->
                           ...
                           <th title="Maximum supply possible"><span class="datatable-header-icon">
                              <!-- Cubes SVG -->
                           ...
                           <th title="Currently circulating supply"><span class="datatable-header-icon">
                              <!-- Circle SVG -->
                           ...
                           <th title="All-time high price"><span class="datatable-header-icon">
                              <!-- Line Chart SVG -->
                           ...
                           <th title="Coin categories"><span class="datatable-header-icon">
                              <!-- Tags SVG -->
