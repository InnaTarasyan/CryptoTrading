...
const languageTexts = {
    ...
    ru: {
        ...
        // LCW Info Card paragraphs
        'LCW Info Card Intro': 'Live Coin Watch — это платформа для отслеживания рынка криптовалют в реальном времени, предлагающая удобный и понятный интерфейс для мониторинга цен, рыночной капитализации, торговых объёмов и рейтингов сотен цифровых активов. В отличие от многих конкурентов, Live Coin Watch обновляет данные в режиме реального времени, что идеально подходит пользователям, которым важно видеть изменения цен по мере их появления.',
        'LCW Info Card Change History': 'История изменений: В приведённой выше таблице содержится полный журнал исторических изменений для различных криптовалют, отслеживаемых Live Coin Watch. Каждая запись отражает обновления цены, рыночной капитализации, торгового объёма и других ключевых метрик со временем. Эта история изменений помогает пользователям анализировать тренды, отслеживать движение рынка и принимать взвешенные решения на основе предыдущих данных и прозрачности. Регулярно обновляемая таблица гарантирует доступ к самым актуальным и точным историческим данным.',
    },
    hy: {
